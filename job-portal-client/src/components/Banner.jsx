...
const Banner = ({query,handleInputChange}) => {
  ...
  return (
    <div className='max-w-screen-2xl container  mx-auto xl:px-24 px-4 md:py-20 py-14'>
      <h1 className='text-5xl font-bold text-primary mb-3 '>Find the <span className='text-blue'>job that suits</span>  you best</h1>
        <p className='text-lg text-black/70 mb-8'>Meet the leaders and join the best companies that are waiting for you!</p>
