...
const MyJobs = () => {
    ...
    useEffect(() => {
        setIsLoading(true)
        fetch(`http://localhost:3000/myJobs/hero@gmail.com`).then(res => res.json()).then(data => {
            setJobs(data);
            setIsLoading(false);
        }) },[searchText])
    // pagination
    ...
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4'>
      <div className='my-jobs-container'>
        ...
        <div className='search-box p-2 text-center mb-2'>
            ...
            type="text" name="search" id="search" className='py-2 pl-3 border focus:outline-none lg:w-6/
            12 mb-4 w-full'/>
    ...
    <div className="rounded-t mb-0 px-4 py-3 border-0">
      <div className="flex flex-wrap items-center">
        ...
        <div className="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
          ...
          type="button">Post a New Job</button></Link>
        </div>
      </div>
    </div>
